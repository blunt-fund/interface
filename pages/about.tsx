...
export default function About() {
  return (
    <>
      ...
      <Container page={true}>
        <main className="mx-auto space-y-12 text-left prose">
          <h1 className="pb-12 text-center">About blunt</h1>
          <div>
            ...
            <p>
              ...
              funding goal, refunds are trustlessly guaranteed to your
              supporters. If you meet your funding goal, you can run your
              project onchain with built-in payout management, token issuance,
              and other incentives: Blunt rounds are{" "}
          ...
          <div>
            ...
            <p>
              ...
              receive its tokens – while the round is ongoing, those tokens can
              be redeemed for a full ETH refund.
            </p>
            <p>
            ...
            <ul>
              <li>
                <b>A hard cap.</b>
                The cap is a maximum amount of ETH or USD a round can raise.
                Once the cap is met, any further payments are rejected.
              </li>
              <li>
                <b>A deadline.</b>
                Blunt rounds can have a deadline. If the round isn&apos;t
                successfully closed by the deadline, further payments are
                rejected and all all funds can be refunded.
              </li>
              {/*<li>
              <b>A slicer.</b>
              ...
              <li>
                ...
                allocation. Blunt lets you lock this percentage in place to
                assure prospective contributors.
              </li>
            </ul>
          </div>
          <div>
            <h2>FAQ</h2>
            <p className="font-semibold">How much does blunt cost?</p>
            <p>
              Blunt only takes a fee from successful rounds in exchange for
              BLUNT governance tokens. The fee varies between 1,5% and 3,5% of
              the total amount raised (excl. the 2,5% Juicebox fee) so the more
              you raise the less you pay.
            </p>

            <p className="font-semibold">How decentralized is blunt?</p>
            <p>
              Blunt is built with decentralized technology: Ethereum and
              Juicebox. Blunt rounds take place onchain, making them transparent
              and unstoppable. Nobody can delete or modify your round.
            </p>

            <p className="font-semibold">How do I use this website?</p>
            <p>
              This website interacts with the Ethereum blockchain – to use it,
              you&apos;ll need to have a wallet and some ETH (the main currency
              on Ethereum). You can get a wallet on{" "}
